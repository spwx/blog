...
deploying. To deploy to a remote server, run:

#+begin_src sh
just deploy <IP>
#+end_src

Where =<IP>= is your server's IP address. The [[https://just.systems/][Just]] command runner
handles all the compilation and deployment steps.
